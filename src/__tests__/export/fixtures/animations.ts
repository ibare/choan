...
// ── 1. Slide up — y translate 0 → -812 ───────────────────────────────────────

export const fadeInElements: ChoanElement[] = [
  ctr('fi-root', 'Slide Up Screen', { width: 375, height: 812, layoutDirection: 'column' }),
  child('fi-modal', 'Modal Overlay', 'fi-root', { z: 1, width: 375, height: 812, color: 0x000000 }),
  child('fi-card', 'Modal Card', 'fi-root', { z: 2, x: 32, y: 200, width: 311, height: 240, radius: 0.1, color: 0xffffff }),
]

export const fadeInBundles: AnimationBundle[] = [
  bundle('fi-bundle', 'Slide Up', [
    clip('fi-clip-overlay', 'fi-modal', [tr('y', [kf(0, 812), kf(300, 0)])]),
    clip('fi-clip-card', 'fi-card', [tr('y', [kf(0, 400), kf(300, 200)])]),
  ]),
]
...
export const slideInElements: ChoanElement[] = [
  ...
  child('si-overlay', 'Overlay', 'si-root', { z: 1, x: 0, y: 0, width: 375, height: 812, color: 0x000000 }),
]
...
export const staggeredListElements: ChoanElement[] = [
  ...
  child('sl-item1', 'List Item 1', 'sl-root', { z: 1, width: 343, height: 56, radius: 0.1, color: 0xffffff }),
  child('sl-item2', 'List Item 2', 'sl-root', { z: 1, width: 343, height: 56, radius: 0.1, color: 0xffffff }),
  child('sl-item3', 'List Item 3', 'sl-root', { z: 1, width: 343, height: 56, radius: 0.1, color: 0xffffff }),
  child('sl-item4', 'List Item 4', 'sl-root', { z: 1, width: 343, height: 56, radius: 0.1, color: 0xffffff }),
]

export const staggeredListBundles: AnimationBundle[] = [
  bundle('sl-bundle', 'Stagger Entrance', [
    clip('sl-clip1', 'sl-item1', [tr('y', [kf(0, 20), kf(200, 0)])], 200),
    clip('sl-clip2', 'sl-item2', [tr('y', [kf(80, 20), kf(280, 0)])], 280),
    clip('sl-clip3', 'sl-item3', [tr('y', [kf(160, 20), kf(360, 0)])], 360),
    clip('sl-clip4', 'sl-item4', [tr('y', [kf(240, 20), kf(440, 0)])], 440),
  ]),
]
